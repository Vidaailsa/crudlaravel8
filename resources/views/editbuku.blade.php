                ...
                <div class="card-body">
                    <form  method="post" action="{{ url('buku/'.$txtid) }}" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                            <input type="text" name="txtpenerbit" id="txtpenerbit" class="form-control form-control-sm @error('txtpenerbit') is-invalid @enderror" value="{{ $txtpenerbit }}">
                            @error('txtpenerbit')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
